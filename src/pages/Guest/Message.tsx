...
export default function Message() {
  ...
  const { user } = useAuth();
  const [selectEventState, setSelectEventState] =
    useRecoilState(selectEventStore);
  ...
  return (
    <SafeAreaView>
      ...
      >
        ...
        <Text className="text-primary-800 text-3xl font-semibold">
          {selectEventState?.name}
        </Text>
